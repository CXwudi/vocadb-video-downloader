...
public interface ThrowableFunction<T, R> {
  ...
  /**
   * the instance method of {@link mikufan.cx.project_vd_common_util.exception.ThrowableFunction#toFunction(mikufan.cx.project_vd_common_util.exception.ThrowableFunction)}
   */
